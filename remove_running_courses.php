...
if (isset($_POST['submit'])) {
    ...
    foreach ($val as $vall) {
        ...
        $sql = " DELETE FROM `running_courses` WHERE stu_Id='$id' AND course_title='$vall'";
        $result = mysqli_query($conn, $sql);
        if ($result) {
          
                echo "<script>alert('Opps! Deleted.')</script>";
        ...
        <div class="rt-container">
            <div class="col-rt-12">
                <div class="rt-heading">
                    ...
                    <h1 style="color:MediumVioletRed;">Remove Running Courses</h1>


                    
                    <h1 style="color:red;">
                        <p class="text-left"> <a href="profile.php">Back</a></p>
                    </h1>
                                ...
                                <form action="" method="POST">
                                    <table class="table table-bordered">
                                        ...
                                        for ($i = 1; $i <= $arrlength; $i++) {
                                            ...
                                            echo "<td>" . "<input type=" . "checkbox" . " name=" . "data[] " . "value=" . $new_str . ">" . "</td>";

                                            for ($j = 1; $j <= 2; $j++) {


                                                if ($j % 2 == 1) echo "<td>" . $contain[$i - 1] . "</td>";
                                                else echo "<td  >" . $contain_right[$i - 1] . "</td>";
                                            }
                                            echo "</tr>";
                                        }
                                        ?>
