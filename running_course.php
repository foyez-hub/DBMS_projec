...
if(isset($_GET['mmi'])){
    ...
    // echo $ti;
              ...
              $sql = "INSERT INTO running_courses (stu_id,course_title) VALUES ('$id','$new_str')";
              $result = mysqli_query($conn, $sql);
        ...
        <div class="rt-container">
            <div class="col-rt-12">
                <div class="rt-heading">
                    ...
                    <h1 style="color:MediumVioletRed;">Select Running Courses</h1>
                    ...
                    <?php
                        ...
                        // echo '<p class="text-left"> <a href="profile_edit.php">Back</a></p>';
                                ...
                                <form action="" method="POST">
                                    <table class="table table-bordered">
                                        ...
                                        for ($i = 1; $i <= $arrlength; $i++) {
                                            ...
                                            $sql = "SELECT * FROM `running_courses` WHERE stu_Id='$id' AND course_title='$new_str'";
                                            $result = mysqli_query($conn, $sql);
                                            if ($result->num_rows ==0) {
                                            ...
                                            echo "<tr>";
                                             ...
                                             echo  '<td><a href="running_course.php?mmi='.$contain[$i-1].'"><h3 style="color:green;"><i class="fa fa-plus-circle"></i></h3></a></td>';
